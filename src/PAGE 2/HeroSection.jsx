        ...
        <div>
            <div className="relative w-full h-screen overflow-hidden">
                ...
                <div className="relative h-full flex items-center mt-10">
                    <div className="container xl:container-fluid mx-auto px-6 lg:px-12">
                        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
                            ...
                            <div className="lg:col-span-3 text-white z-10">
                                ...
                                {featuredMovie.titleImg && (
                                    <div className="mb-6">
                                        <img
                                            ...
                                            className="h-40 sm:h-52 lg:h-60 max-w-md object-contain"
                                        />
                                    </div>
                                )}
                                ...
                                <div className="flex flex-wrap gap-4 pt-2">
                                    <button 
                                        className="bg-red-600 px-6 py-3 rounded-lg text-sm font-semibold hover:bg-red-700 transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-red-600/50 hover:scale-105 active:scale-95"
                                    >
                                    ...
                                    {featuredMovie.trailler && (
                                        <button 
                                            onClick={openTrailer}
                                            className="border-2 border-red-600 px-6 py-3 rounded-lg text-sm font-semibold hover:bg-red-600 transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-red-600/50 hover:scale-105 active:scale-95 group"
                                        >
                                    ...
                                    <div className="relative group flex-shrink-0">
                                        <div className="relative">
                                            ...
                                            {featuredMovie.trailler && (
                                                ...
                                                >
                                                    <div className="bg-red-600 rounded-full p-4 shadow-lg transform scale-75 group-hover:scale-100 transition-transform duration-300 hover:bg-red-700">
