            ...
            <div className="max-w-md mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    type="button"
                    className="flex items-center justify-center gap-3 px-4 py-3 border border-gray-700 rounded-lg text-gray-300 hover:bg-gray-900 hover:border-gray-600 transition-all duration-300"
                  >
