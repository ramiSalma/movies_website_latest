...
const TrendingMovies = ({ title, trendKey }) => {
  ...
  const scroll = (dir) => {
    ...
    const cardWidth = 280; // Fixed width for consistency
    ...
    <div className="w-full min-h-96 text-left flex gap-10 px-10 py-8 bg-black rounded-2xl shadow-xl ">
      ...
      <div className="relative w-3/4 group">
        ...
        <div
          ...
          className="flex flex-nowrap gap-6 overflow-x-auto scrollbar-hide pt-4 pb-6 px-8 scroll-smooth"
          style={{
        ...
        >
          {trending.map((movie, index) => (
            <div
              key={movie._id}
              className="relative flex-shrink-0 w-64 h-80 bg-black/90 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:shadow-red-500/25 transform hover:scale-105 hover:-translate-y-3 transition-all duration-500 ease-out cursor-pointer group/card"
            ...
            >
              ...
              {movie.trend == true ? <div className="absolute bottom-0 left-0 z-10">
                <span 
                  className="text-white text-7xl font-black leading-none select-none"
                  style={{
              ...
              <div className={`absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent transition-all duration-500 ease-in-out ${
                ...
                >
                  <div className="relative">
                    ...
                    <PlayCircleIcon className="relative w-16 h-16 text-white hover:text-red-400 transition-all duration-300 transform group-hover/play:scale-110" />
                  </div>
                </Link>
              </div>
